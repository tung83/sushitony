...
class vamtam_icon_link extends WP_Widget {

	private $max_custom = 10;

	public function __construct() {
		$widget_ops = array(
			'classname'                   => 'vamtam_icon_link',
			'description'                 => esc_html__( 'Displays a list of links preceded by an icon', 'wpv' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'icon-link', esc_html__( 'Vamtam - Links with icons', 'wpv' ) , $widget_ops );
	}
...
register_widget( 'vamtam_icon_link' );
// exit;
