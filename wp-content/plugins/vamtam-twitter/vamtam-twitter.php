...
class Vamtam_Twitter {
	...
	public static function admin_menu() {
		...
		foreach ( $menu as $menu_item ) {
			if ( $menu_item[2] === 'vamtam_general' ) {
				add_submenu_page( 'vamtam_general', __( 'Twitter', 'wpv' ), __( 'Twitter', 'wpv' ), 'edit_theme_options', 'vamtam_twitter', array( __CLASS__, 'plugin_page' ) );
				return;
			}
		}

		add_submenu_page( 'options-general.php', __( 'VamTam Twitter', 'wpv' ), __( 'VamTam Twitter', 'wpv' ), 'edit_theme_options', 'vamtam_twitter', array( __CLASS__, 'plugin_page' ) );
	}
